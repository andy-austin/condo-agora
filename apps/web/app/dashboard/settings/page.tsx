    ...
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <div className="mb-6 p-4 bg-muted/50 rounded-lg border">
        <p className="text-sm text-muted-foreground">
          Your role: <span className="font-semibold text-foreground">{currentMembership?.role}</span>
          {' in '}
          <span className="font-semibold text-foreground">{currentMembership?.organization.name}</span>
        </p>
      </div>
      ...
      {isAdmin ? (
        ...
        <div className="bg-muted/50 border rounded-lg p-6 text-center">
          <p className="text-muted-foreground">
            Only administrators can invite new members and manage organization settings.
          </p>
        </div>
      )}
    </div>
